...
# komutun kullanacağı değer giriliyor
...
def hesapla(nem, ısı, şarj):
    ...
    # argümanlara hangi işlemleri yaptıracaksın
...
aptno = 13
if aptno == 13:
    print("orkide apt tır")
else:
    print("orkide değildir")
...
# Sayı 10 mu diye kontrol edelim.
...
# for döngüsü yazarken bizden beklenilen 2 durum var. 
# 1. durum : bu döngüyü nerede gerçekleştirilecek. 
# 2. durum : hangi isimlendirmeyle yapılacak. 
...
# maaşların için liste yaratalım ve salaries kısmını göster diyelim.
...
# for döngüsünü kullanarak tüm listeyi yüklüyoruz. Ve bütün listeyi hesaplayacak.
...
# elimizde 3 farklı isimde liste var 
# biz bu listelerin elamanlarını eşlemek yani beraber kullanmak istiyoruz
...
# Map:** bize döngü yazmaktan kurtarır, nesne verir ve uygulamak istediğinizi ilet der ve işlemi yapar
...
# yine klasik yoldan 2. şey ekleme yapmak içinde 
# if , else ,
...
alternating("hi my name is SiNaN and i am learning python")
